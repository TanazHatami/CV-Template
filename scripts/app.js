...
menuItems.forEach(item => {
    item.addEventListener("click", function (e) {
        ...
        let secttionClass = item.getAttribute("data-section");
        let sectionOffsetTop = document.querySelector(`.${secttionClass}`).offsetTop;
        window.scroll({
...
function handleIntersect(allSections) {
